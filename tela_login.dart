...
import 'package:skilmatch/telas/tela_cadastro.dart';
...
class _TelaLoginState extends State<TelaLogin> {
  ...
  void _fazerLogin() {
    if (_chaveFormulario.currentState!.validate()) {
      final String emailDigitado = _controladorEmail.text.trim();
      final String senhaDigitada = _controladorSenha.text.trim();
